 ...
 */
public class VisualizarEquipamento extends javax.swing.JFrame {

    /**
     * Creates new form Visualizar
     */
    public VisualizarEquipamento() {
        initComponents();
    ...
    private void initComponents() {
        ...
        dadosTabela.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Nome", "Código", "Fornecedor", "Data Compra", "Quantidade", "Valor", "Limite de Peso"
            }
        ) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VisualizarEquipamento.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
