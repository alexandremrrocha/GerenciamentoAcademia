...
public class AtualizarCliente extends javax.swing.JFrame {
        ...
        if((listaClientes = cCliente.visualizarClientes()) != null)
        {
            ...
            for(Cliente cliente : listaClientes)
            {
                Object[] dados = {cliente.getNome(), cliente.getCpf(), cliente.getEndereco(),
                    ...
                    cliente.getTelefone(), cliente.getRestricao()};
                modelo.addRow(dados);
            }
        }
    }
    ...
    private void tabelaDadosMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tabelaDadosMouseClicked
        ...
        if(resposta == 0){
            ...
            cliente.setNome(tabelaDados.getValueAt(linha, 0).toString());
            ...
            cliente.setTelefone(tabelaDados.getValueAt(linha, 6).toString());
            cliente.setRestricao(tabelaDados.getValueAt(linha, 7).toString());
